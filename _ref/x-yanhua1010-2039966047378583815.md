...
author: Yanhua
author_handle: yanhua1010
published_display: "3:19 pm · 3 Apr 2026"
captured_at: "2026-04-03T11:45:25.776Z"
---

# 用 LLM + Obsidian 构建个人知识库：基于 Karpathy 的“LLM Knowledge Bases”工作流

作者：[@yanhua1010](https://x.com/yanhua1010)

原文链接：[https://x.com/yanhua1010/status/2039966047378583815](https://x.com/yanhua1010/status/2039966047378583815)
...
- [《如何基于 Obsidian 和 Claude 打造 AI 时代超级大脑？》](https://x.com/yanhua1010/status/2020342019575673223)
...
2. Podwise 管播客。自动转录加 AI 摘要，导出 Markdown。我之前专门写过一篇讲这个：[《用 Podwise 把播客变成可检索的知识库》](https://x.com/yanhua1010/status/2033726054351966613)
3. 手动剪藏管 X 推文和零散内容。Claude Code 有个 Skill 叫 `baoyu-url-to-markdown`，丢个链接进去，几秒变干净的 Markdown。
...
来源说明：以下内容由用户提供，作为上文提到的 Andrej Karpathy 原始帖子正文补充保存。

作者：[@karpathy](https://x.com/karpathy)
